...
⑤ 시대·배경 고증 ★★★ 절대 위반 금지
   - 이 작품의 배경은 '{novel.era}'이다. 이 시대·세계에 실재하지 않는 개념·사물·기술·단어·표현을 단 하나도 쓰지 마라.
   - 고증 위반 사례(절대 금지):
     · 고대·중세·역사물: 전화, 인터넷, 카페, 아파트, 엘리베이터, 킬로미터, 그램, 퍼센트, 선글라스, 지퍼, 와이파이 등 현대 사물·단위·개념
     · 판타지·이세계: 현실 지구의 국가명·브랜드·화폐 단위·지명·현대 기술
     · 현대물: 그 시대에 아직 발명·도입되지 않은 기기나 문화
   - 대사와 내레이션 모두 적용된다. 인물이 "~처럼"이라고 비유할 때도 그 시대에 없는 사물을 비유 소재로 쓰지 않는다.
   - 확신이 없는 단어는 해당 시대·세계관의 동의어·대체 표현으로 반드시 교체한다.
   - 이 규칙 위반은 독자 몰입을 즉각 파괴하는 치명적 오류로 간주한다.
